...
public class FileExtractUtils {
    ...
    /***
     * 
     *  Extract file from source file path to output dir
     *  
     *  @param source
     *  @param output
     * 
     */
    public static void extractFile(File source, File output) {
    	if(source.getAbsolutePath().endsWith(".zip")) {
		    FileExtractUtils.extractZip(source, output);
		}
		else if(source.getAbsolutePath().endsWith(".gz")) {
			FileExtractUtils.extractGZip(source, output);
	     }
    }
     ...
     *            the out dir
     */
    public static void extractTarGZip(File tgzFile, File outDir) {
        try {
